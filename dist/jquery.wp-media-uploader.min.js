...
{self.$target.html('');self.$target.html(self.templates.inside);self.$el.trigger('uploader:clear');};self.ready();window.media_uploaders[self.$el.attr('id')]=self;return self;};$(document).ready(function(){$('*[role="media-uploader"][data-editor]').each(function(){$(this).wp_media_uploader();});});})(jQuery);